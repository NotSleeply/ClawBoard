...
### v0.74.0 (2026-05-09)
- 🎨 **代码高亮** - 代码类型记录自动应用语法高亮（highlight.js）
- 📝 **Markdown 预览** - Markdown 类型记录渲染预览
- 🖼 **图片信息** - 图片预览显示尺寸、大小、格式
- 🔍 **悬浮增强** - 悬浮预览支持代码/Markdown/图片信息
...
### v0.72.0 (2026-05-07)
- 🔍 **代码高亮增强** - 自动检测代码语言并语法高亮，无需手动标记
- 🖼️ **图片信息显示** - 详情面板显示图片尺寸、格式（PNG/JPEG等）、文件大小、宽高比
- 🖼️ **图片操作按钮** - 放大/缩小/旋转90°/保存到文件/复制图片到剪贴板
- 📄 **文件内容预览** - 文本文件内联预览，支持 50+ 格式（.txt/.md/.json/.js/.py 等）
